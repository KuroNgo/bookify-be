...
// @Router /api/v1/event-ticket-assignments/get/all [get]
func (e EventTicketAssignmentController) GetAll(ctx *gin.Context) {
	data, err := e.EventTicketAssignmentUseCase.GetAll(ctx)
	if err != nil {
