...
func EventTicketRouter(env *config.Database, timeout time.Duration, db *mongo.Database, group *gin.RouterGroup) {
	...
	router.GET("/get/id", eventTicket.GetByID)
	router.GET("/get/all", eventTicket.GetAll)
}
